...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hello Welcome to the wonders of the world you can know about 7 wonders of the world. How can I help you?';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'You can Ask me about the 7 wonders of the world';
